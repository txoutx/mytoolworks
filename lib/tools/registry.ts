...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    group: "Convertir",
    description: "Convierte paginas PDF en diapositivas. Requiere backend para fidelidad real.",
  ...
  },
  {
    ...
    group: "Convertir",
    description: "Extrae tablas a Excel. Requiere backend/OCR para resultados fiables.",
  ...
  },
  {
    ...
    group: "Convertir",
    description: "Ordena imagenes y conviertelas en un PDF.",
    keywords: ["jpg a pdf", "imagenes a pdf"],
    status: "Disponible",
    processing: "client",
    input: "multi-file",
    output: "pdf"
  },
  {
    ...
    group: "Convertir",
    description: "Convierte HTML o una URL a PDF. Requiere backend/headless browser.",
    keywords: ["html a pdf", "web a pdf"],
    status: "Requiere backend",
    processing: "backend-required",
    input: "html",
    output: "pdf"
